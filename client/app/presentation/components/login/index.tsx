...
export function LoginCard() {
  ...
  if (isAuthenticated) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-6">
        <section className="w-full max-w-2xl rounded-2xl border border-green-200 dark:border-green-900 bg-white dark:bg-gray-900 shadow-sm p-6 space-y-6">
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 p-6">
      <section className="w-full max-w-md rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 shadow-sm p-6 space-y-4">
        <header>
        ...
        <div className="pt-3 border-t border-gray-200 dark:border-gray-800 text-xs font-mono text-gray-500 dark:text-gray-400 flex items-center gap-2">
          ...
          Sessão exigida para acesso aos serviços distribuídos.
        </div>
      </section>
    </main>
  );
