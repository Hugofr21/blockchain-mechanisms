    ...
    return (
      <main className="max-w-7xl mx-auto p-6">
        <p className="font-mono text-indigo-600 animate-pulse">
          Synchronizing cryptographic ledger with the container {targetNodePort}...
        </p>
      </main>
    );
  }
  ...
  return (
    <main className="max-w-7xl mx-auto p-6">
      ...
      <p className="text-sm text-gray-500 mb-6 font-mono">
        Querying the state matrix of the isolated container: <span className="font-bold text-gray-800 dark:text-gray-200">{targetNodePort}</span>
      </p>
