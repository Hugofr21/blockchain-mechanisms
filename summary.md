...
#### 2.1. Análise de requisitos e de ataque

Durante a primeira fase de levantamento de requisitos foram identificados os seguintes vetores de ataque:

| Vetor                   | Descrição                                                                                 |
| ----------------------- | ------------------------------------------------------------------------------------------- |
| **Sybil**         | Um atacante cria múltiplas identidades falsas para ganhar controle sobre a rede.           |
| **Eclipse**       | O nó alvo é isolado da visão global da rede, recebendo apenas informações manipuladas. |
| **Replay Attack** | Mensagens válidas são capturadas e re‑enviadas posteriormente para enganar o protocolo.  |
| **Hijack**        | Um nó legítimo tem seu tráfego desviado ou sua sessão interrompida por um adversário.  |
| **Spoofing**      | Um atacante finge ser outro nó ou serviço, enviando informações falsas.                 |

Essas ameaças orientam a escolha de mecanismos como **identificação criptográfica**, **assinaturas digitais**, **timestamps**, **chaves públicas/privadas** e **validação de rotas**.
